    ...
    >
      <div className='container mx-auto w-full flex flex-wrap justify-between'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0 flex flex-col items-start'>
          ...
          <p className='text-lg font-medium md:pr-24'>
        ...
        <div className='w-full md:w-1/3 flex flex-col items-start'>
          ...
          <p className='text-xs md:text-sm font-light leading-6'>
            <a
        ...
        <div className='w-full md:w-1/3 flex flex-col items-start mt-4 md:mt-0'>
          <p className='text-sm mb-2 text-light-purple'>Quick links</p>
          <div className='flex flex-wrap w-full text-xs md:text-sm'>
            <div className='flex flex-col w-1/2 my-2 md:w-32 gap-4'>
