...
export default function SectionCaseStudy() {
  return (
    <section id='case-study'>
      <div className="flex flex-wrap bg-deep-purple min-h-900 py-24 justify-center items-center p-4 bg-[url('/images/fibre-phoenix-case-study-bird.svg')] bg-no-repeat bg-right">
        ...
        <div className='w-4/12 self-start text-left py-8'>
