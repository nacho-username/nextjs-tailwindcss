    ...
    <section className='bg-beige text-center px-16 text-deep-grey pt-2 pb-32 md:pb-64'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 md:pt-16'>
        {featureCards.map((feature, index) => (
          <div
            key={index}
            className={`flex flex-col items-center justify-center text-left p-4 md:p-8 rounded-lg bg-white shadow-xl hover:bg-deep-purple group cursor-pointer ${
      ...
      <SolidButton label='let’s build something great' href='contact' />
    </section>
  )
}
